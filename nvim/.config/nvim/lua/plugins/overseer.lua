return {
  ...
  keys = {
    { "<leader>tt", ":OverseerToggle<cr>",           desc = "Overseer List Toggle" },
    { "<leader>tr", ":OverseerRun<cr>",              desc = "Overseer Run" },
    { "<leader>tR", ":OverseerRunCmd<cr>",           desc = "Overseer Run Cmd" },
    ...
    { "<leader>td", "<cmd>OverseerDeleteBundle<cr>", desc = "Overseer Delete Bundle" },
    ...
    { "<leader>ts", "<cmd>OverseerSaveBundle<cr>",   desc = "Overseer Save Bundle" },
  },
  config = function()
