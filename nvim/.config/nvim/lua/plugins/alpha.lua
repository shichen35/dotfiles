return {
  ...
  opts = function()
    ...
    -- vim.api.nvim_set_hl(0, "NeovimDashboardLogo1", { fg = "#DA4939" })  -- 深红
    -- vim.api.nvim_set_hl(0, "NeovimDashboardLogo2", { fg = "#E07553" })  -- 深红向橙红过渡
    -- vim.api.nvim_set_hl(0, "NeovimDashboardLogo3", { fg = "#E7A76D" })  -- 橙红向黄色过渡
    -- vim.api.nvim_set_hl(0, "NeovimDashboardLogo4", { fg = "#EFD290" })  -- 黄色更明亮
    -- vim.api.nvim_set_hl(0, "NeovimDashboardLogo5", { fg = "#B7CF64" })  -- 黄绿
    -- vim.api.nvim_set_hl(0, "NeovimDashboardLogo6", { fg = "#7FBA89" })  -- 绿色
    -- vim.api.nvim_set_hl(0, "NeovimDashboardLogo7", { fg = "#5AA1CF" })  -- 蓝绿向蓝色过渡
    -- vim.api.nvim_set_hl(0, "NeovimDashboardLogo8", { fg = "#3D71AC" })  -- 淡蓝
    --
    ...
    local headerPadding = winHeight >= contentHeight and fn.ceil((winHeight - contentHeight) / 2) + 1 or 0
