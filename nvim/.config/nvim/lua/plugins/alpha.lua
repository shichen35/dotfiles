return {
  ...
  opts = function()
    ...
    local headerPadding = winHeight >= contentHeight
        and fn.ceil((winHeight - contentHeight) / 2)
      or 0
  ...
  config = function(_, dashboard)
    ...
    local insert_toggle_group =
      vim.api.nvim_create_augroup('alpha_inserttoggle', { clear = false })
